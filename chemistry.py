def main():
    ...
    chem_fomula = input("Input a chemical formula: ")
    # Get the mass of a chemical sample in grams from the user.
    sample_mass = float(input("What is the mass in grams: "))
    ...
    parsed_formula = parse_formula(chem_fomula,periodic_table)
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    mm = compute_molar_mass(parsed_formula, periodic_table)
    # Compute the number of moles in the sample.
    moles = sample_mass / mm
    # Print the molar mass.
    print(f'{mm:.2f} grams/mole')
    # Print the number of moles.
    print(f'{moles:.2f} moles')
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for inner_list in symbol_quantity_list:
        symbol = inner_list[0]
        quanity = inner_list[1]
        atomic_mass = periodic_table_dict[symbol][1]
        molar_mass = atomic_mass * quanity
